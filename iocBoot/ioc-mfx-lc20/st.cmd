...
epicsEnvSet( "LOCATION",  "MFX:LC20:IOC:01" )
...
epicsEnvSet( "DEV1", "MFX:LC20:SDS" )
epicsEnvSet( "DEV2", "MFX:LC20:SDSB" )
epicsEnvSet( "DEV3", "MFX:LC20:SDSC" )
drvAsynIPPortConfigure( "$(DEV1)", "digi-mfx-01:2105 TCP", 0, 0, 0 )
drvAsynIPPortConfigure( "$(DEV2)", "digi-mfx-01:2106 TCP", 0, 0, 0 )
drvAsynIPPortConfigure( "$(DEV3)", "digi-mfx-01:2107 TCP", 0, 0, 0 )
...
# Setup autosave
save_restoreSet_status_prefix( "MFX:LC20:IOC:01:" )
