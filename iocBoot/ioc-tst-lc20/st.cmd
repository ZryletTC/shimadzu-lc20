...
epicsEnvSet( "LOCATION",  "TST:LC20:IOC:01" )
...
epicsEnvSet( "DEV1", "TST:LC20:01" )
drvAsynIPPortConfigure( "$(DEV1)", "digi-tst-130.pcdsn:2113 TCP", 0, 0, 0 )

# Load record instances
dbLoadRecords( "db/iocAdmin.db",			"IOC=TST:LC20:IOC:01" )
dbLoadRecords( "db/save_restoreStatus.db",	"IOC=TST:LC20:IOC:01" )
...
# Setup autosave
save_restoreSet_status_prefix( "TST:LC20:IOC:01:" )
