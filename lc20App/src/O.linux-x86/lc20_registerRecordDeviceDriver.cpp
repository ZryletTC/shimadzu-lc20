...
/* Generated from ../O.Common/lc20.dbd */
...
int lc20_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/reg/g/pcds/package/epics/3.14-dev/ioc/common/shimadzu-lc20/current";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"lc20_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    lc20_registerRecordDeviceDriver(*iocshPpdbbase);
}
